...
//NESTE EXEMPLO UMA DIRECAO FOI UTILIZADA, PORTANTO PINGER SO PODE ENVIAR //DADOS PARA C E NAO RECEBELOS

//chan<- : so envia
//<-chan : so recebe

//um canal sem indicacoes é considerado bidirecional

//tentar receber ou enviar em canais que foram espeficados, indo contra
//o que foi declarado ira causar erro de compilacao
